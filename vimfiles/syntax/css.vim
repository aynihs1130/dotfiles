...
syn keyword cssTagName dfn dir div dl dt em fieldset font form frame object
...
syn keyword html5TagName article aside canvas details figcaption figure footer header hgroup menu nav section summary time mark audio video
...
syn keyword cssBoxProp contained width height float clear overflow clip visibility opacity filter
